...
class Mytable
{
    ...
    public static function creerConnexion()
    {
        ...
        try {
            $connexion = new PDO(
                'mysql:host=localhost;dbname=guide_duchemin',
                'root',
                '',
                array(
    ...
    public function afficherTable()
    {
        ...
        while ($row = $this->statement->fetch()) {
            $chaine .= "<tr><td><form action='affichedetail.php' method='POST'  enctype='multipart/form-data' >
...
{
        $sql="UPDATE ".$this->table." set  name=:nom , addresse=:adresse, prix=:prix , commentaire=:commentaire , note=:note, date_de_visite=:date where id=".$_id;
